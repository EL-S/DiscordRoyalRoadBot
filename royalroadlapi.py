...
def get_chapters(chapter_links,directory_loc="Fictions/"):
    ...
    if chapter_links != []:
        ...
        final_location = save_to_hdd(fiction_html,chapters_html,chapters_downloaded,directory)
        return final_location
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <opf:guide>
    ...
    folder_location = directory + folder_name
    final_location = compress_and_convert_to_epub(directory,folder_location,output_location)
    return final_location
